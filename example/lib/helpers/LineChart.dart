...
class LineChart extends StatelessWidget {
  ...
  LineChart({
    ...
    required Iterable<PaintStyle?>
        seriesPointsStyles, // null would use predefined set of styles
    required Iterable<PaintStyle> seriesLinesStyles, // null for default
  })  : horizontalLinesPaint = horizontalLinesStyle.toPaint(),
        verticalLinesPaint = verticalLinesStyle?.toPaint(),
        seriesPointsPaints = _prepareSeriesPointsPaints(seriesPointsStyles) as List<ui.Paint?>,
        seriesLinesPaints = _prepareSeriesLinesPaints(seriesLinesStyles) as List<ui.Paint> {
...
class _LineChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
        ...
        Iterable<LabelEntry> generator(double optimalStepValue, int stepsNumber,
          ...
          for (int i = 0; i < stepsNumber; i++) {
            yield LabelEntry(
              ...
              value = value != null ? value += optimalStepValue: 0;
    ...
    Iterator<Paint> linesPaints = seriesLinesPaints.iterator;
